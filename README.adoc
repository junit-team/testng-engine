...
* https://search.maven.org/remotecontent?filepath=org/junit/compat/testng-engine/{testng-engine-version}/testng-engine-{testng-engine-version}.jar[testng-engine-{testng-engine-version}.jar]
...
dependencies {
    ...
    testRuntimeOnly("org.junit.compat:testng-engine:{testng-engine-version}") // <.>
}
tasks.test {
    useJUnitPlatform() // <.>
}
...
<project>
    ...
    <dependencies>
        ...
        <dependency>
            <groupId>org.junit.compat</groupId>
